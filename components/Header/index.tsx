          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  href="/signin"
                  className="ease-in-up rounded-md py-3 px-8 text-base font-bold text-xl text-dark dark:text-white transition duration-300 md:block md:px-9 lg:px-6 xl:px-9"
                >
                  <FaRightToBracket />
                </Link>
                <div>
